  ...
  wayland.windowManager.mango = {
    ...
    settings = {
      ...
      bind = [
        ...
        # switch window focus
        "ALT,J,focusstack,next"
        "ALT,K,focusstack,previous"
        "ALT,Up,focusdir,up"
        ...
        "CTRL,Return,spawn,${terminalBin}"
        "SUPER,Escape,spawn,${noctaliaBin} msg panel-open control-center"
        "SUPER,Space,spawn,${noctaliaBin} msg panel-open launcher"
